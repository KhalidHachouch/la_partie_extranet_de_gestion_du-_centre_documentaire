...
<div class="col-main">
	...
	<?php if(phoneNumber()) { ?><p><strong>Télephone : </strong><?php echo phoneNumber(); ?></p> <?php } ?>
	<?php if(email()) { ?><p><strong>Adresse Email : </strong><?php echo email(); ?></p> <?php } ?>
	<?php if(address()) { ?><p><strong>Adresse : </strong><?php echo address(); ?></p> <?php } ?>
	</div>
	<input type="hidden" class="emailaddress_admin" value="<?php echo email(); ?>" />
	
	<div class="loader_mail" style="position: absolute;">Envoi en cours...</div>
