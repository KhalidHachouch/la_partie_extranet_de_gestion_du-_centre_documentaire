      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					?>-->
					<li ><a href="bookscl.php"><i class="icon-book icon-large"></i>&nbsp;Ouvrages</a></li>
					<li class="active"><a href="reserver.php"><i class="icon-book icon-large"></i>&nbsp;mes demandes</a></li>
