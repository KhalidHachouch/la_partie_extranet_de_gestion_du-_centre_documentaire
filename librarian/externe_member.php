			...
			<div class="span12">	
			   <!--div class="alert alert-info">
                                ...
                                <ul class="nav nav-pills">
										...
										<li class="active"><a href="externe_member.php">Externe member</a></li>
									</ul>
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from member where type='externe'")or die(mysqli_error());
