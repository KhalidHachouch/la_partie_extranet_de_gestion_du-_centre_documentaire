                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  $user_query=mysqli_query($conn,"select * from book where status != 'Archive'")or die(mysqli_error());
									...
									$row111 = mysqli_fetch_array($borrow_details);
                                    ...
                                    <td class="action">
                                        <!--a rel="tooltip"  title="Suprimmer" id="<?php echo $id; ?>" href="#delete_book<?php echo $id; ?>" data-toggle="modal"    class="btn btn-danger"><i class="icon-trash icon-large"></i></a>
                                        <?php include('delete_book_modal.php'); ?>-->
										<a  rel="tooltip"  title="Emprinter" id="e<?php echo $id; ?>" href="pret.php<?php echo '?id='.$id; ?>" class="btn btn-success">Emprinter</a>
