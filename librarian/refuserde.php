			...
			<div class="span12">	
			   <div class="alert alert-info">
                                 ...
                                 <ul class="nav nav-pills">
										...
										<li class="active"><a href="refuserde.php">Demandes refusees</a></li>
					...
					<input type="date"  class="w8em format-d-m-y highlight-days-67 range-low-today" name="datee" id="ssd" maxlength="10" style="border: 3px double #CCCCCC;" required/>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                	<?php  $user_query=mysqli_query($conn,"select * from demande join member on demande.member_id=member.member_id where demande.status_demande='refuser'")or die(mysqli_error());
