			...
			<div class="span12">	
			   <!--div class="alert alert-info">
                                ...
                                <ul class="nav nav-pills">
										...
										<li><a href="new_member.php">Nouveau member</a></li>
										<li class="active"><a href="interne_member.php">Interne member</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from member where type='interne'")or die(mysqli_error());
                                    ...
                                    <td><a  rel="tooltip" id="a<?php echo $id; ?>" href="activer.php<?php echo '?id='.$id; ?>" class="btn btn-success">Activer</a>
                                    <a  rel="tooltip" id="a<?php echo $id; ?>" href="desactiver.php<?php echo '?id='.$id; ?>" class="btn btn-danger">Desactiver</a>
