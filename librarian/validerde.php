			...
			<div class="span12">	
			   <div class="alert alert-info">
                                 ...
                                 <ul class="nav nav-pills">
										...
										<li class="active"><a href="validerde.php">Demandes validees</a></li>
				...
				<?php
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                	<?php  $user_query=mysqli_query($conn,"select * from demande join member on demande.member_id=member.member_id where demande.status_demande='valider'")or die(mysqli_error());
                                    ...
                                    <td><a  rel="tooltip" id="a<?php echo $id; ?>" href="cloture.php<?php echo '?id='.$id; ?>" class="btn btn-success">Retrait</a>   
									</td>
